...
var siteMenu={findMenu:function(n,t){var u,i,r;for(u in t){if(i=t[u],i.Id==n)return i.SubMenus;if(r=siteMenu.findMenu(n,i.SubMenus),r!=null)return r}return null},buildMenu:function(n,t,i){var r,f;menuBuilder.addMenuButton("Home",function(){navigation.entryPoint()});t!=null&&menuBuilder.addMenuButton("<<",function(){menuBuilder.clearNode("menuDiv");menuBuilder.clearNode("viewsMenu");siteMenu.buildMenu(n,i)});r=n;t!=null&&(r=siteMenu.findMenu(t,n));for(f in r){var s=f,u=r[f],o=u.Name,e=function(n){return function(){siteMenu.executeUIAction(n)}}(u.Event);u.Event==null&&(e=function(i){return function(){menuBuilder.clearNode("menuDiv");siteMenu.buildMenu(n,i.Id,t)}}(u));menuBuilder.addMenuButton(o,e)}},processEvent:function(n,t,i,r){var u={Data:t||"",ActionId:i};u=JSON.stringify(u);main.makeWebCall(main.webApiURL+"processEvent/"+n,"POST",siteMenu.processUIActionResponse,u,r)},executeUIAction:function(n,t){var i={Data:t||""};i=JSON.stringify(i);main.makeWebCall(main.webApiURL+"executeUIAction/"+n,"POST",siteMenu.processUIActionResponse,i,t)},processUIActionResponse:function(n,t){var f=n[0],i,r,u,e,o;n.splice(0,1);i=function(){};n.length>0&&(i=function(n){return function(){siteMenu.processUIActionResponse(n,t)}}(n));r=f;u=-1;r!=null&&r.ActionType!=null&&(u=r.ActionType);e=f;switch(u){case-1:inputDialog.showMessage(e,i,null);break;case 0:o=f.ViewData;siteMenu.populateView(o,r,null,t);i();break;case 1:siteMenu.buildInput(r,t);i();break;case 4:inputDialog.cancelInput();i();break;case 5:inputDialog.showMessage(e,i,r.Data);break;case 6:siteMenu.executeUIAction(r.EventNumber,r.ParametersToPass);i();break;default:inputDialog.showMessage("unknown action type: "+u,i,null)}},buildInput:function(n,t){inputDialog.loadInputPage("InputDialog.html",function(){var ri=document.getElementById("pageTitle"),wt,lt,bt,y,o,i,p,g,s,c,dt,at,l,a,it,rt,h,vt,yt,ut,gt,ft,w,et,ni,ot,st,ht,f,r,ti,e,oi,b,u,pt,k;ri.innerHTML=n.Description;var ct=document.getElementById("inputTable"),v=[],d=function(n){for(var i,t=0;t<v.length;t++)if(i=v[t],i.TriggerInputName==n)return!0;return!1};for(u=0;u<n.InputFields.length;u++)if(i=n.InputFields[u],i.VisibilityConditions!=null&&i.VisibilityConditions.length>0)for(wt=i.InputName,s=0;s<i.VisibilityConditions.length;s++)lt=i.VisibilityConditions[s],bt={InputName:wt,Condition:lt,TriggerInputName:lt.ColumnName},v.push(bt);for(y=function(n,t){var r=n.value,u,i,e,f,n;for(n.type=="checkbox"&&(r=n.checked),r=r+"",u=0;u<v.length;u++)if(i=v[u],i.TriggerInputName==t){for(e="_"+i.InputName,f=!0,i.Condition.Comparison==0?f=r===i.Condition.ColumnValue:i.Condition.Comparison==1?f=r!=i.Condition.ColumnValue:alert("Unknown comparison "+i.Condition.Comparison),n=document.getElementById(e);n.tagName!="TR";)n=n.parentNode;n.style.display=f?"":"none"}},u=0;u<n.InputFields.length;u++){o=document.createElement("tr");v.push(u);i=n.InputFields[u];switch(i.InputType){case 0:case 1:f=document.createElement("td");f.innerHTML=i.InputLabel;o.appendChild(f);r=document.createElement("input");r.type=i.InputType==1?"password":"text";r.id="_"+i.InputName;i.DefaultValue!=null&&i.DefaultValue.length>0&&(r.value=i.DefaultValue);d(i.InputName)&&(r.onchange=function(n){return function(){y(this,n)}}(i.InputName));e=document.createElement("td");e.appendChild(r);o.appendChild(e);break;case 2:inputDialog.addHiddenField("_"+i.InputName,i.DefaultValue);break;case 3:for(f=document.createElement("td"),f.innerHTML=i.InputLabel,o.appendChild(f),p=document.createElement("select"),d(i.InputName)&&(p.onchange=function(n){return function(){y(this,n)}}(i.InputName)),p.id="_"+i.InputName,g=i.ListItems,s=0;s<g.length;s++)h=document.createElement("option"),h.value=g[s],h.text=g[s],p.appendChild(h);i.DefaultValue!=null&&i.DefaultValue.length>0&&(p.value=i.DefaultValue);e=document.createElement("td");e.appendChild(p);o.appendChild(e);break;case 4:f=document.createElement("td");f.innerHTML=i.InputLabel;o.appendChild(f);r=document.createElement("input");d(i.InputName)&&(r.onchange=function(n){return function(){y(this,n)}}(i.InputName));r.type="checkbox";r.id="_"+i.InputName;i.DefaultValue!=null&&(r.checked=i.DefaultValue);e=document.createElement("td");e.appendChild(r);o.appendChild(e);break;case 5:f=document.createElement("td");f.innerHTML=i.InputLabel;o.appendChild(f);ct.appendChild(o);o=document.createElement("tr");c=document.createElement("table");c.style.fontSize="75%";c.frame="box";c.cellPadding="0";c.style.padding="0";var nt=document.createElement("tr"),tt=document.createElement("tr"),ui=document.createElement("tr"),fi=document.createElement("tr"),kt=document.createElement("td");for(kt.innerHTML=i.SelectedItemsLabel,dt=document.createElement("td"),at=document.createElement("td"),at.innerHTML=i.AvailableItemsLabel,nt.appendChild(kt),nt.appendChild(dt),nt.appendChild(at),l=document.createElement("select"),l.multiple=!0,l.id="_"+i.InputName+"_1",l.size=5,l.style.width="100%",a=document.createElement("select"),a.multiple=!0,a.id="_"+i.InputName+"_2",a.size=5,a.style.width="100%",it=0;it<i.ListSource.length;it++){for(rt=i.ListSource[it],h=document.createElement("option"),h.value=rt.Key,h.text=rt.Value,vt=!1,yt=i.DefaultValue||[],ut=0;ut<yt.length;ut++)if(gt=yt[ut],gt==rt.Key){vt=!0;break}vt?l.appendChild(h):a.appendChild(h)}ft=document.createElement("td");ft.rowSpan=3;ft.appendChild(l);tt.appendChild(ft);w=document.createElement("td");w.rowSpan=3;et=document.createElement("button");et.innerHTML="<<";et.onclick=function(n){return function(){for(var r="_"+n+"_1",u="_"+n+"_2",f=document.getElementById(r),i=document.getElementById(u),t=i.options.length-1;t>=0;t--)i.options[t].selected&&f.appendChild(i.options[t])}}(i.InputName);w.appendChild(et);ni=document.createElement("br");w.appendChild(ni);ot=document.createElement("button");ot.innerHTML=">>";ot.onclick=function(n){return function(){for(var r="_"+n+"_1",u="_"+n+"_2",i=document.getElementById(r),f=document.getElementById(u),t=i.options.length-1;t>=0;t--)i.options[t].selected&&f.appendChild(i.options[t])}}(i.InputName);w.appendChild(ot);tt.appendChild(w);st=document.createElement("td");st.rowSpan=3;st.appendChild(a);tt.appendChild(st);c.appendChild(nt);c.appendChild(tt);c.appendChild(ui);c.appendChild(fi);ht=document.createElement("td");ht.colSpan=3;ht.appendChild(c);o.appendChild(ht);break;case 6:f=document.createElement("td");f.innerHTML=i.InputLabel;o.appendChild(f);r=document.createElement("input");ti="_"+i.InputName;r.type="text";r.id=ti;i.DefaultValue!=null&&i.DefaultValue.length>0&&(r.value=i.DefaultValue);d(i.InputName)&&(r.onchange=function(n){return function(){y(this,n)}}(i.InputName));Modernizr.inputtypes.date==!0?r.type="date":(alert("mask input"),MaskedInput({elm:r,format:"MM/DD/YYYY",separator:"/",typeon:"MDY",allowedfx:function(n,t){var i=document.getElementById("_Date").value;switch(t){case 1:return"01".indexOf(n)>-1;case 2:if(i[0]==="1")return"012".indexOf(n)>-1;break;case 4:return"0123".indexOf(n)>-1;case 5:if(i[3]==="3")return"01".indexOf(n)>-1;break;case 7:return"12".indexOf(n)>-1}return!0}}));e=document.createElement("td");e.appendChild(r);o.appendChild(e);break;default:inputDialog.showMessage("Unknown input type: "+i.InputType);continue}ct.appendChild(o)}for(u=0;u<n.InputFields.length;u++){var i=n.InputFields[u],ei="_"+i.InputName,ii=document.getElementById(ei);ii!=null&&y(ii,i.InputName)}for(oi=document.createElement("tr"),b=document.createElement("td"),b.colSpan=2,u=0;u<n.InputButtons.length;u++)pt=n.InputButtons[u],k=document.createElement("button"),k.style.margin="10px",k.innerHTML=pt.Label,k.onclick=function(i,r){return function(){for(var c={},f,u,e,h,s,o=0;o<r.InputFields.length;o++){if(f=r.InputFields[o],f.InputType==5)for(e=[],u=document.getElementById("_"+f.InputName+"_1"),h=u.options,s=0;s<h.length;s++)e.push(h[s].value);else{if(u=document.getElementById("_"+f.InputName),u==null)continue;e=u.value;u.type=="checkbox"&&(e=u.checked)}c[f.InputName]=e}t!=null&&t.length>0;siteMenu.processEvent(n.Id,c,i,t)}}(pt.ActionNumber,n),b.appendChild(k);b.style.textAlign="center";b.style.verticalAlign="middle";ct.appendChild(b)})},populateView:function(n,t,i){navigation.loadHtmlBody("mainContent","Views.html",function(){var it=views.getTable(),l=document.createElement("tr"),ot=document.getElementById("viewsTitle"),w,e,s,b,rt,a,v,c,y,nt,ft,u,tt,o,et;for(ot.innerHTML=t.Description,e=0;e<t.Columns.length;e++)w=document.createElement("th"),w.innerHTML=t.Columns[e].ColumnLabel,l.appendChild(w);for(it.appendChild(l),u=0;u<n.length;u++){for(l=document.createElement("tr"),e=0;e<t.Columns.length;e++){var r=t.Columns[e],h=document.createElement("td"),f="";if(r.ColumnName!=null&&r.ColumnName.length>0){for(f=n[u],s=r.ColumnName;s.indexOf(".")>-1;)b=s.indexOf("."),rt=s.substring(0,b),f=f[rt],s=s.substring(b+1);f=f[s]}if(r.ColumnType==1?(f==!0?f=r.TrueValueDisplay:f==!1&&(f=r.FalseValueDisplay),h.innerHTML=f):r.ColumnType==2?(o=document.createElement("button"),o.onclick=function(i,r){return function(){var o=n[i].Id,f=JSON.stringify(n[i]),u=t.Columns[r],e;u.Event.ActionType==5?inputDialog.showMessage(u.Event,null,f):u.Event.ActionType==6?(e=u.Event.EventNumber,f=n[i].Id,siteMenu.executeUIAction(e,f)):inputDialog.showMessage("Unknown action type "+u.Event.ActionType)}}(u,e),r.ButtonTextSource==0?o.innerHTML=r.ButtonText:(inputDialog.showMessage("Unhandled ButtonTextSource: "+r.ButtonTextSource),o.innerHTML="????"),h.appendChild(o)):r.ColumnType==3?(a=document.createElement("a"),a.href="#",a.innerHTML=r.LinkLabel,a.onclick=function(t,i){return function(){var r={Id:n[i][t.KeyColumn]},u=t.EventNumber;siteMenu.executeUIAction(u,r)}}(r,u),h.appendChild(a)):h.innerHTML=f,r.ColumnSetting!=null&&r.ColumnSetting.ColumnSettingType==0){for(v=r.ColumnSetting.Display==0,c=!0,y=0;y<r.ColumnSetting.Conditions.length;y++){var k=r.ColumnSetting.Conditions[y],s=k.ColumnName,d=k.Comparison,ut=k.ColumnValue,p=n[u][s]||"";p=p.toString();d==0?c=c&&p==ut:d==1?c=c&&p!=ut:alert("Unknown comparison: "+d)}if(c==!1&&v==!0||c==!0&&v==!1){var v=r.ColumnSetting.Display==0,st=h.innerHTML,g=document.createElement("div");g.innerHTML=st;nt=document.createElement("td");nt.appendChild(g);g.style.display="none";h=nt}}l.appendChild(h)}it.appendChild(l)}for(ft=document.getElementById("viewsMenu"),menuBuilder.clearNode("viewsMenu"),u=0;u<t.ViewMenu.length;u++)tt=t.ViewMenu[u],o=document.createElement("button"),o.innerHTML=tt.Label,o.onclick=function(n,i){return function(){var r=t.ViewMenu[i];siteMenu.executeUIAction(n,r.ParametersToPass)}}(tt.EventNumber,u),ft.appendChild(o);et=document.getElementById("viewsFooter");et.innerHTML=t.ViewMessage!=null&&t.ViewMessage.length>0?t.ViewMessage:"";i&&i()})}};
